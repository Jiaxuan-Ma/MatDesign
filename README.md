...
MatDesign is capable of effectively discovering novel materials with high-potential advanced properties end-to-end, utilizing model inference, surrogate optimization, 
...
## Remote access（远程访问）website: 

`www.matdesign.group`


## Overview and architecture of MatDesign（MatDesign的架构和功能模块）

<img src="https://github.com/user-attachments/assets/1cdb76d9-88db-4aa2-b146-b2758eacbc83" width="500px">


## Flowcharts of materials design in MatDesign platform（单目标/多目标材料设计流程图）
...
**Given the limitation of computational resources, we strongly recommend deploying MatDesign on your local machine!!!**
